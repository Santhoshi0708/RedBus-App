  ...
  const handleFeedback = (type) => {
    ...
    return (
        ...
        <ScrollView contentContainerStyle={{}}>
            ...
            <Text style={{fontSize:22,fontWeight:'bold',marginTop:20,paddingHorizontal:20}}>Where can I view the train ticket that I have booked through redRail?</Text>
            <Text style={{ fontSize:18,marginTop:20,paddingHorizontal:20}}>After you have successfully booked a train ticket through redRail, you will receive an email, a WhatsApp message and a text message containing the details about your booking. You can also view your bookings under the 'My Bookings' section of the redBus app.</Text>
