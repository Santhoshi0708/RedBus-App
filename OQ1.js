  ...
  const handleFeedback = (type) => {
    ...
    return (
        ...
        <ScrollView contentContainerStyle={{}}>
            ...
            <Text style={{fontSize:22,fontWeight:'bold',marginTop:20,paddingHorizontal:20}}>Do I need to carry any documents with me when I board the bus?</Text>
            <Text style={{ fontSize:18,marginTop:20,paddingHorizontal:20}}>Carry one Govt. ID Proof along with the redBus generated Ticket when you board the bus.</Text>
