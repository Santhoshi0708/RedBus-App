  ...
  const handleFeedback = (type) => {
    ...
    return (
        ...
        <ScrollView contentContainerStyle={{}}>
            ...
            <Text style={{fontSize:22,fontWeight:'bold',marginTop:20,paddingHorizontal:20}}>Can I book a train ticket under the Tatkall quota through redRail?</Text>
            <Text style={{ fontSize:18,marginTop:20,paddingHorizontal:20}}>Yes,you can book Tatkal quota train tickets through redRail. With the convinience of viewing updated trains and their berth availability, it is advisble to complete your online train ticket booking at the earliest through redRail.
