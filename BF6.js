  ...
  const handleFeedback = (type) => {
    ...
    return (
        ...
        <ScrollView contentContainerStyle={{}}>
            ...
            <Text style={{fontSize:22,fontWeight:'bold',marginTop:20,paddingHorizontal:20}}>Do I get to choose a seat or berth of my choice?</Text>
            <Text style={{ fontSize:18,marginTop:20,paddingHorizontal:20}}>No, you cannot select your seat/birth. The seat and berth are allocated by Indian Railways, and there is no option to choose seat/berth preferences while booking a ticket through redRail/redBus, ut that is not guaranteed.</Text>
