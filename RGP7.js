  ...
  const handleFeedback = (type) => {
    ...
    return (
        ...
        <ScrollView contentContainerStyle={{}}>
            ...
            <Text style={{fontSize:22,fontWeight:'bold',marginTop:20,paddingHorizontal:20}}>Will my refund guarantee be refunded when I cancel my ticket?</Text>
            <Text style={{ fontSize:18,fontWeight:'bold',marginTop:20,paddingHorizontal:20}}>No, on user initiated cancellation refund guarantee amount will not be refunded.</Text>
