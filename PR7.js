...
const App = ({ navigation }) => {
    ...
    return (
        ...
        <ScrollView contentContainerStyle={{}}>
            ...
            <Text style={{fontSize:25,fontWeight:'bold',marginTop:20,paddingHorizontal:20}}>Will I get refund in case of a failed transaction?</Text>
          <Text style={{ fontSize: 20, color: 'black', marginBottom: 15,marginTop:20 ,marginHorizontal:20}}>Yes, the funds in case of a failed transaction if debited from redBus wallet is credited back in 15 minutes and if debited from source is credited back in 7 bank working days.</Text>
