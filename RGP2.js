  ...
  const handleFeedback = (type) => {
    ...
    return (
        ...
        <ScrollView contentContainerStyle={{}}>
            ...
            <Text style={{fontSize:22,fontWeight:'bold',marginTop:20,paddingHorizontal:20}}>How does Refund guarantee work?</Text>
            <View style={{ padding: 10, marginHorizontal: 20, marginTop: 20 }}>
  {[
    "Opt-in for 'refund guarantee' while booking your bus ticket",
    "If your travel plans are canceled, go to 'My Bookings' and cancel your ticket before the cut-off time (4 hours before journey start time)",
    "Enjoy ZERO penalty and get the full ticket fare instantly refunded",
    "The cancellation charge will be waived off automatically"
  ].map((text, index) => (
