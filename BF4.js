  ...
  const handleFeedback = (type) => {
    ...
    return (
        ...
        <ScrollView contentContainerStyle={{}}>
            ...
            <Text style={{fontSize:22,fontWeight:'bold',marginTop:20,paddingHorizontal:20}}>How do I change the boarding point after the train ticket is booked?</Text>
            <Text style={{ fontSize:18,marginTop:20,paddingHorizontal:20}}>Boarding point cannot be changed once the ticket is bbooked on redRail. In this case, you need to cancel the booking and rebook it with the revised boarding point.
