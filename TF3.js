  ...
  const handleFeedback = (type) => {
    ...
    return (
        ...
        <ScrollView contentContainerStyle={{}}>
            ...
            <Text style={{fontSize:22,fontWeight:'bold',marginTop:20,paddingHorizontal:20}}>Why is Tatkal window different for redRail?</Text>
            <Text style={{ fontSize:18,marginTop:20,paddingHorizontal:20}}>This is as per rules of the Indian railways, tatkal window for bookings on redRail begin at 10:15AM (IST) for AC class and 11:15AM (IST) for non-AC class.
            </Text>
