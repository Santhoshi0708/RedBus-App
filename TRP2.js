  ...
  const handleFeedback = (type) => {
    ...
    return (
        ...
        <ScrollView contentContainerStyle={{}}>
            ...
            <Text style={{fontSize:22,fontWeight:'bold',marginTop:20,paddingHorizontal:20}}>Is the Trip Rewards available for everyone? Am I eligible for the Trip Rewarrds program?</Text>
            <Text style={{ fontSize:18,marginTop:20,paddingHorizontal:20}}>No, Trip Reward is an invite only loyalty program offered by bus operators to select redBus customers based on their past history with the platform.
                Not all the users are eligible for this program. If you are eligible for this program, you would be able to see the 'Trip Reward' logo when you search for buses.
            </Text>
