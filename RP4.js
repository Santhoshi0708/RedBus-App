...
const App = ({ navigation }) => {
  ...
  const handleFeedback = (type) => {
    ...
    I have booked a ticket, but it's not showing up in the routePass program.
  </Text>
  <Text style={{ fontSize: 18, marginTop: 20, paddingHorizontal: 20 }}>
    After booking a ticket, you would need to ‘unlock’ the routePass program. For unlocking, please go to the ticket in your app from the My Bookings section and unlock.{"\n\n"}
    You should also be able to unlock the routePass program from the home page. Please note that unlock of the routePass will be available only till the date of journey.
  </Text>
