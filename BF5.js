  ...
  const handleFeedback = (type) => {
    ...
    return (
        ...
        <ScrollView contentContainerStyle={{}}>
            ...
            <Text style={{fontSize:22,fontWeight:'bold',marginTop:20,paddingHorizontal:20}}>How many people can I book on a single train ticket booking?</Text>
            <Text style={{ fontSize:18,marginTop:20,paddingHorizontal:20}}>Customers can book a maximum of 6 passengers in a single train ticket booking that is booked throough redRail. However, in the case of Tatkaal ticket, customers can book a maximum of 4 passengers in a single ticket booking.</Text>
