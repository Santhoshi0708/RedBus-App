...
const [fromPlace, setFromPlace] = useState(null);
  ...
  const Data2 = [{ id: 1, t1: 'Digha - Kolkata', t3: 'From', t4: ' ₹ 153', t5: 'Book Now' },
  { id: 2, t1:'Digha - Salt Lake', t3: 'From', t4: ' ₹ 153', t5: 'Book Now' },
  { id: 3, t1: 'Salt Lake - Durgapur', t3: 'From', t4: ' ₹ 150', t5: 'Book Now' },
  { id: 4, t1: 'Kolkata - Durgapur', t3: 'From', t4: ' ₹ 150', t5: 'Book Now' },
  { id: 5, t1: 'Durgapur - Kolkata', t3: 'From', t4: ' ₹ 150', t5: 'Book Now' },
  ];
  ...
  : {
      heading: 'কেন redBus-এ টিকিট বুক করবেন?',
      steps: [
        {id: 1,  icon: 'text-box-check-outline', title: 'ভ্রমণের বিবরণ দিন', subtitle: 'কোথা থেকে কোথায়, কখন যেতে চান তা দিন' },
        { id: 2,icon: 'bus-clock', title: 'বাস নির্বাচন করুন', subtitle: 'আমাদের তালিকা থেকে আপনার পছন্দের বাস নির্বাচন করুন' },
        { id: 3,icon: 'car-child-seat', title: 'আসন নির্বাচন করুন', subtitle: 'আপনার আসন এবং বোর্ডিং / ড্রপিং পয়েন্ট নির্বাচন করুন' },
        { id: 4,icon: 'credit-card-marker', title: 'যোগাযোগের তথ্য ও পেমেন্ট', subtitle: 'আপনার যোগাযোগের তথ্য দিন এবং পেমেন্ট করুন' },
      ]
    };
 const placeList = [
  ...
  const onDateChange = (event, selectedDate) => {
   ...
   const renderItem = ({ item }) => {
      return (
        <View style={{ paddingHorizontal: 20, alignItems: 'center', paddingTop: 30, backgroundColor: 'white' }}>
  
          <Card style={{ width: 320, height: 200, shadowColor: 'white',backgroundColor:'white',}}>
    ...
    <Provider>
      <ScrollView contentContainerStyle={{ paddingBottom: 100, }}>
        <View style={{ flexDirection: 'row', alignItems: 'center', padding: 10, backgroundColor: 'red', height: 60, }}>
          ...
          <Text style={{ fontSize: 22, marginLeft: 15 ,color:'white',fontWeight:'bold'}}>SBSTC Booking</Text>
        </View>
...
<ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ paddingHorizontal: 10 }}>
  <View style={{ flexDirection: 'row', gap: 20, marginTop: 30, paddingHorizontal: 20 }}>
    <Card style={{ height: 180, width: 280, backgroundColor: 'white' ,shadowColor:'white'}}>
      <Card.Content style={{ marginTop: 10 }}>
        <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
          <Text style={{ fontSize: 20, color: 'black' }}>R  Devi</Text>
    ...
    <Card style={{ height: 180, width: 280, backgroundColor: 'white',shadowColor:'white' }}>
      <Card.Content style={{ marginTop: 10 }}>
        <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
          <Text style={{ fontSize: 20, color: 'black' }}>K Anusha Reddy</Text>
          <View style={{ backgroundColor: 'green', borderRadius: 15, paddingHorizontal: 10 }}>
            <Text style={{ color: 'white', fontWeight: 'bold' }}>★ 5</Text>
          </View>
        </View>
        <Text style={{ marginTop: 10, fontSize: 16, color: 'black' }}>
          SBSTC is my go-to travel choice in Telangana.
        </Text>
      </Card.Content>
    </Card>
  </View>
          ...
          <View style={{ marginTop: 20 }}>
                      ...
                      <View style={{ flexDirection: 'row', marginTop: 10 }}>
                        ...
                        <TouchableOpacity
                          ...
                          <Text style={{ fontWeight: 'bold' }}>Bengali</Text>
                        </TouchableOpacity>
                      </View>
                    </View>
