...
<View style={{ flexDirection: 'row', alignItems: 'center', padding: 10, backgroundColor: 'red', height: 60, paddingRight: 50, borderColor: 'red', borderBottomWidth: 1 }}>
        ...
        <ScrollView contentContainerStyle={{}}>
            ...
            <Text style={{fontSize:22,fontWeight:'bold',marginTop:20,paddingHorizontal:20}}>Can I get discounts & offers on bus tickets at redBus?</Text>
          <Text style={{ fontSize: 18, color: 'black', marginBottom: 15,marginTop:20,marginHorizontal:20}}>Yes, you will get the best fares on bus tickets bookings on redBus by applying coupon codes before completing your transaction. To check for your eligible offers & to make your bus booking online at the lowest prices on redBus, kindly refer the Offers section
