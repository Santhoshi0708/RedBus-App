...
const App = ({ navigation }) => {
  const items = [
    { label: 'How to cancel a ticket?' ,nav:'TR1'},
    { label: 'Are there any cancellation charges levied when a bus ticket is cancelled?'  ,nav:'TR2'},
    { label: 'How to reschedule a ticket?'  ,nav:'TR3'},
  ...
  return (
    <ScrollView contentContainerStyle={{}}>
      <View style={{ flexDirection: 'row', alignItems: 'center', padding: 10, backgroundColor: 'red', height: 60,paddingRight:50,borderColor:'red',borderBottomWidth:1 }}>
        ...
        <Text style={{ fontSize: 20, fontWeight: 'bold', color: 'white', paddingLeft: 20 }}>Ticket Reschedule / Cancellation</Text>
      </View>
