...
const App = ({ navigation }) => {
  const Data1 = [{ id: 4, t1: 'Get Rs 80 offer on train tickets', t2: 'Valid till: 30 Apr', t3: 'SUPER60', colour: 'lightblue', t4: 'Train', card: 'of7' }];
  const item = Data1[0];
  ...
  return (
    <View style={{ flex: 1 }}>
      <View style={{ flexDirection: 'row', alignItems: 'center', padding: 10, backgroundColor: 'red', height: 60, }}>
                ...
                <Text style={{ fontSize: 20, fontWeight: 'bold', color: 'white', textAlign: 'center', padding: 10 }}>NOFEE</Text>
            </View>
