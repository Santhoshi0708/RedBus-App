  ...
  const handleFeedback = (type) => {
    ...
    return (
        ...
        <ScrollView contentContainerStyle={{}}>
            ...
            <Text style={{fontSize:22,fontWeight:'bold',marginTop:20,paddingHorizontal:20}}>Can I cancel the refund guarantee after purchasing it?</Text>
            <Text style={{ fontSize:18,fontWeight:'bold',marginTop:20,paddingHorizontal:20}}>No, It is not possible to cancel refund guarantee once purchased</Text>
