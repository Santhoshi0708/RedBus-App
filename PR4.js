...
const App = ({ navigation }) => {
    ...
    return (
        ...
        <ScrollView contentContainerStyle={{}}>
            ...
            <Text style={{fontSize:25,fontWeight:'bold',marginTop:20,paddingHorizontal:20}}>I missed the bus. Do I get a refund?</Text>
          <Text style={{ fontSize: 20, color: 'black', marginBottom: 15,marginTop:20 ,marginHorizontal:20}}>redBus provides a 100% refund if the bus is missed due to either redBus or its partner company's falt. However, if the bus is missed due to any other reason not directly related to redBus no refund is provided.</Text>
