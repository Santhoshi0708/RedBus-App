  ...
  const handleFeedback = (type) => {
    ...
    return (
        ...
        <ScrollView contentContainerStyle={{}}>
            ...
            <Text style={{fontSize:22,fontWeight:'bold',marginTop:20,paddingHorizontal:20}}>I did not get seat or berth of my choice, what to do?</Text>
            <Text style={{ fontSize:18,marginTop:20,paddingHorizontal:20}}>If you have selected seat or berth preferences while booking your ticket with redRail, it is subject to avaialability and not available based on the preference, alternative seats will be assaigned to the passengers.</Text>
