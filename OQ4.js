  ...
  const handleFeedback = (type) => {
    ...
    return (
        ...
        <ScrollView contentContainerStyle={{}}>
            ...
            <Text style={{fontSize:25,fontWeight:'bold',marginTop:20,paddingHorizontal:20}}>I lost my ticket. What should I do now?</Text>
            <Text style={{ fontSize:20,marginTop:20,paddingHorizontal:20}}>A copy of the ticket would have been sent to you by email and WhatsApp/SMS when you booked it. If you have not received the ticket e-mail or message, please call our helpline (<Text style={{fontSize:20,textDecorationLine:'underline',color:"blue"}}>918045672000</Text>) and our executives will resend you a copy.</Text>
