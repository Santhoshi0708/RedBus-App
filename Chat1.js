...
export default function ChatBot({ navigation }) {
    const [messages, setMessages] = useState([
        ...
        {id:2, text:'Technical issue', sender:'user'}
    ...
    const options = [
        ...
        'No buses found',
        'Delete saved credit/debit card',
        'Unable to make payment',
        'Incorrect fare displayed',
        'Unable to login',
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', height: 60, }}>
                ...
                <View>
                    <Text style={{ fontSize: 22, marginLeft: 15, color: 'black', fontWeight: 'bold' }}>Technical Issues</Text>
                    <Text style={{ fontSize: 16, color: 'grey', marginLeft: 15 }}>Need some technical help?</Text>
                </View>
            </View>
            <ScrollView >
                <FlatList
                ...
                <View style={{ backgroundColor: 'lightgrey', padding: 20, marginRight: 70, marginTop: 40, borderRadius: 10 }}>
                    <Text style={{ fontSize: 16, color: 'black' }}>Sure! Please let me know, how</Text>
                    <Text style={{ fontSize: 16, color: 'black' }}>can I help you?</Text>
