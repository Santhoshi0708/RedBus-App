...
const placeList = [
  ...
  const Data2 = [{ id_: 1, t1: 'Hyderabad - Vijayawada', t3: 'From', t4: ' ₹ 272', t5: 'Book Now' },
  { id_: 2, t1: 'Secunderabad - Vijayawada', t3: 'From', t4: ' ₹ 272', t5: 'Book Now' },
  { id_: 3, t1: 'Vijayawada - Secunderabad', t3: 'From', t4: ' ₹ 362', t5: 'Book Now' },
  { id_: 4, t1: 'Vijayawada - Hyderabad ', t3: 'From', t4: ' ₹ 362', t5: 'Book Now' },
  ];
    ...
    <Provider>
      <ScrollView contentContainerStyle={{ paddingBottom: 100, backgroundColor: '#fff' }}>
        <View style={{ flexDirection: 'row', alignItems: 'center', padding: 10, backgroundColor: 'red', height: 60 }}>
          ...
          <Text style={{ fontSize: 22, marginLeft: 15, color: 'white', fontWeight: 'bold' }}>APSRTC Booking</Text>
        </View>

        <View style={{ padding: 20 }}>
          <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 20 }}>
            <View style={{ flex: 1, paddingRight: 10 }}>
              <Text style={{ fontSize: 22, color: 'black', fontWeight: 'bold', lineHeight: 32 }}>
                ఆంధ్రప్రదేశ్ రాష్ట్ర రోడ్డుబస్సు సంస్థ
              </Text>
            ...
            <Image
              source={{ uri: 'https://tse1.mm.bing.net/th?id=OIP.mP5V7eWNVVmZruMBP4JlsAAAAA&pid=Api&P=0&h=220' }}
...
<View style={{ marginVertical: 20, paddingHorizontal: 10, backgroundColor: 'white',}}>
        ...
        <View style={{ padding: 20 }}>
          ...
          <FlatList data={Data2} renderItem={renderItem2} keyExtractor={(item) => item.id_} />
        ...
        <Text style={{ fontSize: 25, color: 'black', fontWeight: 'bold', }}>Customer Reviews</Text>
        <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{  }}>
          <View style={{ flexDirection: 'row', gap: 20, marginTop: 30, paddingHorizontal: 20 }}>
            <Card style={{ height: 180, width: 280, backgroundColor: 'white',borderWidth:1,borderColor:'lightgrey',shadowColor:'white' }}>
              <Card.Content style={{ marginTop: 10 }}>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                  <Text style={{ fontSize: 20, color: 'black' }}>P Ganesh Kumar</Text>
                ...
                <Text style={{ marginTop: 20, fontSize: 16, color: 'black' }}>
                  Smooth journey, on-time and clean buses. Very happy with the APSRTC booking experience.
                </Text>
              </Card.Content>
            </Card>
            ...
            <Card style={{ height: 180, width: 280, backgroundColor: 'white',borderWidth:1,borderColor:'lightgrey',shadowColor:'white' }}>
              <Card.Content style={{ marginTop: 10 }}>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                  <Text style={{ fontSize: 20, color: 'black' }}>S Lakshmi Narayana</Text>
                  <View style={{ backgroundColor: 'green', borderRadius: 15, paddingHorizontal: 10 }}>
                    <Text style={{ color: 'white', fontWeight: 'bold' }}>4.5 ★</Text>
                  </View>
                </View>
                <Text style={{ marginTop: 20, fontSize: 16, color: 'black' }}>
                  Booking was fast, and support is great. Buses were clean and safe.
                </Text>
              </Card.Content>
            </Card>
          </View>
