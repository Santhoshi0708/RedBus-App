    ...
    <View style={styles.container}>
      {/* Chat Messages */}
       <View style={{ flexDirection: 'row', alignItems: 'center', height: 60, }}>
                ...
                <View>
                <Text style={{ fontSize: 22, marginLeft: 15 ,color:'black',fontWeight:'bold'}}>Offers</Text>
                <Text style={{fontSize:16,color:'grey',marginLeft:15}}>Need help with offers?</Text>
                </View>
              </View>
     <ScrollView>      
      <FlatList
      ...
      />
       <View style={{ backgroundColor: 'lightgrey', padding: 20, marginRight: 70, marginTop: 40, borderRadius: 10 }}>
                          <Text style={{ fontSize: 16, color: 'black' }}>Click the below link to see all our</Text>
                          <Text style={{ fontSize: 16, color: 'black' }}>exiting offers. If you are unable</Text>
                          <Text style={{ fontSize: 16, color: 'black' }}>to use any offrer code, read the</Text>
                          <Text style={{ fontSize: 16, color: 'black' }}>offer T&C to understand eligibility</Text>
                        <Text style={{ fontSize: 16, color: 'black' }}>rules.</Text>
                          ...
                          <Text style={{ fontSize: 16, color: 'black' }}>Does that resolve your query?</Text>
                              ...
                              {options.map((item, index) => (
                                  <TouchableOpacity key={index} style={{ borderBottomWidth: 0.5, borderColor: 'lightgrey', paddingVertical: 15,borderRadius:10 }}>
