...
const [fromCity, setFromCity] = useState('');
  ...
  const Data = [{ id: 1, name: 'HIM DHARA', imgurl: 'https://tse4.mm.bing.net/th?id=OIP.mOUqr3sn7OtgvZXw7_zM0gHaEK&pid=Api&P=0&h=220' },
    { id: 2, name: 'HIMGAURAV', imgurl: 'https://tse2.mm.bing.net/th?id=OIP.Yj0zTiP2fnL_r3AkhP2eWwHaE8&pid=Api&P=0&h=220' },
    { id: 3, name: 'HIMMANI DELUXE', imgurl: 'https://tse1.mm.bing.net/th?id=OIP.tLv0-uVeIiXCS-1yHqiOAwHaE3&pid=Api&P=0&h=220' },
    { id: 4, name: 'Deluxe', imgurl: 'https://tse2.mm.bing.net/th?id=OIP.E_b7L1WR3jrXQkfadBWidQHaEc&pid=Api&P=0&h=220' },
    { id: 5, name: 'HIMSUTA', imgurl: 'https://tse3.mm.bing.net/th?id=OIP._G_Yj4X_0fvl0xkF9hKHvAHaEQ&pid=Api&P=0&h=220' },
    { id: 6, name: 'HIMTARANG', imgurl: 'https://tse3.mm.bing.net/th?id=OIP.YWPUQmZdxrE3F3JrVu2BowHaFj&pid=Api&P=0&h=220' },
    ];
  const Data2 = [{ id: 1, t1: 'Delhi Airport - Panchkula', t3: 'From', t4: ' ₹ 275', t5: 'Book Now' },
  { id: 2, t1:'Delhi - Chandigarh', t3: 'From', t4: ' ₹ 275', t5: 'Book Now' },
  { id: 3, t1: 'Delhi Airport - Chandigarh', t3: 'From', t4: ' ₹ 275', t5: 'Book Now' },
  { id: 4, t1: 'Delhi - Panchkula', t3: 'From', t4: ' ₹ 275', t5: 'Book Now' },
  { id: 5, t1: 'Delhi Airport - Mohali', t3: 'From', t4: ' ₹ 275', t5: 'Book Now' },
  ];
  ...
  : {
      heading: 'redBus पे टिकट क्यों बुक करै?',
      steps: [
        { id: 1, icon: 'text-box-check-outline', title: 'यात्रा के ब्योरे भर', subtitle: 'कहाँ सै कहाँ और कितनै बजे जानै सै यो भर' },
        { id: 2, icon: 'bus-clock', title: 'बस चुनो', subtitle: 'अपणी पसंद की बस लिस्ट में तै चुन लो' },
        { id: 3, icon: 'car-child-seat', title: 'सीट चुनो', subtitle: 'सीट और चढ़ण-उतरण की जगह चुन लो' },
        { id: 4, icon: 'credit-card-marker', title: 'संपर्क जानकारी भर और पैसे दे', subtitle: 'अपणी जानकारी दे और टिकट खातर पेमेंट कर दे' },
      ]
    };
    ...
    <Provider>
      <ScrollView contentContainerStyle={{ paddingBottom: 100, }}>
        <View style={{ flexDirection: 'row', alignItems: 'center', padding: 10, backgroundColor: 'red', height: 60, }}>
          ...
          <Text style={{ fontSize: 22, marginLeft: 15 ,color:'white',fontWeight:'bold'}}>HRTC Booking</Text>
        </View>
        <View style={{ padding: 20 }}>
          <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 20 }}>
            ...
            <Image source={{ uri: 'https://tse2.mm.bing.net/th?id=OIP.VNzx4E0e0Sq_GWZ2Uy_6vAAAAA&pid=Api&P=0&h=220'}} style={{ height: 60, width: 60, borderRadius: 50 }} />
          </View>
           <View style={{
            borderWidth: 1,
            borderColor: 'grey',
...
<ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ paddingHorizontal: 10 }}>
  <View style={{ flexDirection: 'row', gap: 20, marginTop: 30, paddingHorizontal: 20 ,shadowColor:'white'}}>
    <Card style={{ height: 180, width: 280, backgroundColor: 'white',shadowColor:'white' }}>
      <Card.Content style={{ marginTop: 10 }}>
        <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
          <Text style={{ fontSize: 20, color: 'black' }}>Ravi Kiran</Text>
        ...
        <Text style={{ marginTop: 10, fontSize: 16, color: 'black' }}>
          "On Time and bus was very clean"
        </Text>
      </Card.Content>
    </Card>
    ...
    <Card style={{ height: 180, width: 280, backgroundColor: 'white',shadowColor:'white' }}>
      <Card.Content style={{ marginTop: 10 }}>
        <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
          <Text style={{ fontSize: 20, color: 'black' }}>K Reddy</Text>
          <View style={{ backgroundColor: 'green', borderRadius: 15, paddingHorizontal: 10 }}>
            <Text style={{ color: 'white', fontWeight: 'bold' }}>★ 5</Text>
          </View>
        </View>
        <Text style={{ marginTop: 10, fontSize: 16, color: 'black' }}>
          Good experience.Good behaviour.
        </Text>
      </Card.Content>
    </Card>
  </View>
          ...
          <View style={{ marginTop: 20 }}>
                     ...
                     <View style={{ flexDirection: 'row', marginTop: 10 }}>
                       ...
                       <TouchableOpacity
                         ...
                         <Text style={{ fontWeight: 'bold' }}>Haryanvi</Text>
                       </TouchableOpacity>
                     </View>
                   </View>
