  ...
  const handleFeedback = (type) => {
    ...
    return (
        ...
        <ScrollView contentContainerStyle={{}}>
            ...
            <Text style={{fontSize:22,fontWeight:'bold',marginTop:20,paddingHorizontal:20}}>What happens to my refund guarantee if I reschedule my booking?</Text>
            <Text style={{ fontSize:18,fontWeight:'bold',marginTop:20,paddingHorizontal:20}}>In case of reschedule, the refund guarantee is not applicable on the rescheduled ticket. The rescheduled ticket will remain non-cancellable. Refund guarantee will not be refunded.</Text>
