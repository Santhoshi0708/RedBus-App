  ...
  const handleFeedback = (type) => {
    ...
    return (
        ...
        <ScrollView contentContainerStyle={{}}>
            ...
            <Text style={{fontSize:22,fontWeight:'bold',marginTop:20,paddingHorizontal:20}}>Why am I not able to redeem my free ticket despite booking all of the required number of tickets?</Text>
            <Text style={{ fontSize:18,marginTop:20,paddingHorizontal:20}}>You will be able to redeem the reward only when you book and complete the bus journey of all toickets of the 'earning' cycle with the same bus operator. Also, note that the free ticket has to be redeemed and the bus journey has to be completed within the specified time frame.</Text>
