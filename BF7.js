  ...
  const handleFeedback = (type) => {
    ...
    return (
        ...
        <ScrollView contentContainerStyle={{}}>
            ...
            <Text style={{fontSize:22,fontWeight:'bold',marginTop:20,paddingHorizontal:20}}>Where can I view the traiin ticket that I have booked through redRail?</Text>
            <Text style={{ fontSize:18,marginTop:20,paddingHorizontal:20}}>After you have successfully booked  atrain ticket through redRail, you will receive an email, a whatsApp message and a text message containing the details about your bookings under the 'My Bookings' section of the redBus app.</Text>
