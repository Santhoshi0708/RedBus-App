...
const App = ({ navigation }) => {
  ...
  const handleFeedback = (type) => {
    ...
    Is the routePass available for everyone? Am I eligible for the routePass program?
  </Text>
  <Text style={{ fontSize: 18, marginTop: 20, paddingHorizontal: 20 }}>
    No, routePass is a loyalty program offered by redBus on select routes to customers who have done more than 1 booking on redBus platform.{"\n\n"}
    If you are eligible for this program, you would be able to see the ‘routePass’ banner on the bus results page when you search for buses on applicable routes.
  </Text>
