  ...
  const handleFeedback = (type) => {
    ...
    return (
        ...
        <ScrollView contentContainerStyle={{}}>
            ...
            <Text style={{fontSize:22,fontWeight:'bold',marginTop:20,paddingHorizontal:20}}>How do I opt-in for a refund guarantee for my nooking?</Text>
            <Text style={{ fontSize:18,marginTop:20,paddingHorizontal:20}}>You can purchase refund guarantee by selecting yes on Refund Guarantee section while booking a ticket on the customer information screen (where customers need to enter passenger details)</Text>
