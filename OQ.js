...
const App = ({ navigation }) => {
    const items = [
       { id:'Do I need to carry any documents with me when I board the bus?',nav:'OQ1'},
        {id:'What is the child fare policy?',nav:'OQ2'},
        {id:'What is the luggagae policy?',nav:'OQ3'},
        {id:'I lost my ticket. What should I do now?',nav:'OQ4'},
        {id:'How can i rate or review a bus service?',nav:'OQ5'},
      ];
  ...
  return (
    <ScrollView contentContainerStyle={{}}>
      <View style={{ flexDirection: 'row', alignItems: 'center', padding: 10, backgroundColor: 'red', height: 60,paddingRight:50,borderColor:'red',borderBottomWidth:1 }}>
        ...
        <Text style={{ fontSize: 25, fontWeight: 'bold', color: 'white', paddingLeft: 20 }}>Other Queries</Text>
      </View>
