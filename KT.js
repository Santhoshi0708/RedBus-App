...
const [fromPlace, setFromPlace] = useState(null);
  ...
  const Data2 = [{ id: 1, t1: 'Mop Airport - Margaon', t3: 'From', t4: ' ₹ 157', t5: 'Book Now' },
  { id: 2, t1:'Mopa Airport - Goa', t3: 'From', t4: ' ₹ 157', t5: 'Book Now' },
  { id: 3, t1: 'Mopa Airort - South Goa', t3: 'From', t4: ' ₹ 157', t5: 'Book Now' },
  { id: 4, t1: 'Mopa Airport - North Goa', t3: 'From', t4: ' ₹ 157', t5: 'Book Now' },
  { id: 5, t1: 'Mopa Airport - Mohali', t3: 'From', t4: ' ₹ 157', t5: 'Book Now' },
  ];
  ...
  : {
      heading: 'redBus वर तिकिट का बुक करावे?',
      steps: [
        { id: 1, icon: 'text-box-check-outline', title: 'प्रवासाचे तपशील भरा', subtitle: 'कोठून कोठे आणि कधी प्रवास करायचा आहे ते भरा' },
        { id: 2, icon: 'bus-clock', title: 'बस निवडा', subtitle: 'आमच्या यादीतील तुमच्या पसंतीची बस निवडा' },
        { id: 3, icon: 'car-child-seat', title: 'आसन निवडा', subtitle: 'आसन तसेच चढण्याची/उतरण्याची ठिकाणे निवडा' },
        { id: 4, icon: 'credit-card-marker', title: 'संपर्क तपशील भरा आणि पैसे भरा', subtitle: 'तुमचा संपर्क तपशील द्या आणि पेमेंट करून तिकीट मिळवा' },
      ]
    };
    ...
    <Provider>
      <ScrollView contentContainerStyle={{ paddingBottom: 100, }}>
        <View style={{ flexDirection: 'row', alignItems: 'center', padding: 10, backgroundColor: 'red', height: 60, }}>
          ...
          <Text style={{ fontSize: 22, marginLeft: 15 ,color:'white',fontWeight:'bold'}}>KTCTC Booking</Text>
        </View>
        <View style={{ padding: 20 }}>
          <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 20 }}>
            <View style={{ flex: 1, paddingRight: 10 }}>
              <Text style={{ fontSize: 22, color: 'black', fontWeight: 'bold', lineHeight: 32 }} numberOfLines={2}>
              कदंब ट्रांसपोर्ट कॉरपोरेशन लिमिटेड
              </Text>
              <Animated.Text style={{ fontSize: 16, marginTop: 10, opacity: fadeAnim }}>
                {texts[index]}
              </Animated.Text>
            </View>
            <Image source={{ uri: 'https://tse1.mm.bing.net/th?id=OIP.rLC4Og3GHKoBs78qie9dvgAAAA&pid=Api&P=0&h=220'}} style={{ height: 60, width: 60, borderRadius: 50 }} />
          </View>
         <View style={{
                     borderWidth: 1,
                     borderColor: 'grey',
...
<ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ paddingHorizontal: 10 }}>
  <View style={{ flexDirection: 'row', gap: 20, marginTop: 30, paddingHorizontal: 20 }}>
    <Card style={{ height: 200, width: 330, backgroundColor: 'white' }}>
      <Card.Content style={{ marginTop: 10 }}>
        <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
          <Text style={{ fontSize: 20, color: 'black' }}>Kiran</Text>
    ...
    <Card style={{ height: 200, width: 330, backgroundColor: 'white' }}>
      <Card.Content style={{ marginTop: 10 }}>
        <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
          <Text style={{ fontSize: 20, color: 'black' }}>Kailash M</Text>
          <View style={{ backgroundColor: 'green', borderRadius: 15, paddingHorizontal: 10 }}>
            <Text style={{ color: 'white', fontWeight: 'bold' }}>★ 3.8</Text>
          </View>
        </View>
        <Text style={{ marginTop: 10, fontSize: 16, color: 'black' }}>
          Good experience and behaviour.
        </Text>
      </Card.Content>
    </Card>
  </View>
           ...
           <View style={{ marginTop: 20 }}>
                      ...
                      <View style={{ flexDirection: 'row', marginTop: 10 }}>
                        ...
                        <TouchableOpacity
                          ...
                          <Text style={{ fontWeight: 'bold' }}>Kadhambham</Text>
                        </TouchableOpacity>
                      </View>
                    </View>
