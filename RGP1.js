  ...
  const handleFeedback = (type) => {
    ...
    return (
        ...
        <ScrollView contentContainerStyle={{}}>
            ...
            <Text style={{fontSize:25,fontWeight:'bold',marginTop:20,paddingHorizontal:20}}>What is Refund guarantee?</Text>
          <Text style={{ fontSize: 20, color: 'black', marginBottom: 15,marginTop:20 ,marginHorizontal:20}}>Refund guarantee gives you the freedom to cancel your bus tickets without paying any cancellation charges. Get the full ticket fare refunded with zero penalty till 4 hours before start of Journey.</Text>
