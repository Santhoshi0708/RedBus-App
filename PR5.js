...
const App = ({ navigation }) => {
    ...
    return (
        ...
        <ScrollView contentContainerStyle={{}}>
            ...
            <Text style={{fontSize:25,fontWeight:'bold',marginTop:20,paddingHorizontal:20}}>How can I get a refund in case I cancel my ticket?</Text>
          <Text style={{ fontSize: 20, color: 'black', marginBottom: 15,marginTop:20 ,marginHorizontal:20}}>The refund is provided as per with our cancellation policy. The refund can be credited to the souce of payment (Example: debit card,credit card,net banking) or credited to redBus wallet. Wallet credit can be used for bus booking in future (within 6 months of cancellation).</Text>
