...
const App = ({ navigation }) => {
  const Data1 = [{
    id: 3,
    t1: 'Get Rs 80 off on train tickets',
    ...
    <View style={{ flex: 1 }}>
      <View style={{ flexDirection: 'row', alignItems: 'center', padding: 10, backgroundColor: 'brown', height: 60 }}>
        ...
        <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
          <Text style={{ fontSize: 20, fontWeight: 'bold', color: 'white', textAlign: 'center', padding: 10 }}>redRail offer</Text>
        </View>
      </View>

      <View style={{ alignItems: 'center', marginTop: 20 }}>
        <Card style={{ backgroundColor: item.colour, width: 320, height: 250, borderRadius: 15, overflow: 'hidden', alignItems: 'center', justifyContent: 'center' }}>
          <Card.Content>
        ...
        <View style={{ width: '100%' }}>
          ...
          {[
            ...
            <View key={index} style={{ flexDirection: 'row', alignItems: 'flex-start', marginBottom: 12 }}>
              <Text style={{ fontSize: 16, fontWeight: 'bold', marginRight: 8 }}>{index + 1}.</Text>
