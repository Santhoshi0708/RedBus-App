...
const App = ({ navigation }) => {
  ...
  const data = [
    ...
    },
    {
      ...
      text: '6. You can track the return status by going to the Bookings Tab and selecting the canceled ticket.',
    },
  ];
...
<Text style={{fontSize:20,fontWeight:'bold',paddingHorizontal:25,marginTop:10}}>How to cancel a ticket?</Text>
      {/* ScrollView Content */}
      <ScrollView>
        <ScrollView
          horizontal
