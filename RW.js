...
const App = ({ navigation }) => {
    const items = [
       { id:'My wallet shows incorrect balance. What do I do?',nav:'RW1'},
        {id:'I want to know the terms & conditions regarding usuage of redBus wallet',nav:'RW2'},
  ...
  return (
    <ScrollView contentContainerStyle={{}}>
      <View style={{ flexDirection: 'row', alignItems: 'center', padding: 10, backgroundColor: 'red', height: 60,paddingRight:50,borderColor:'red',borderBottomWidth:1 }}>
        ...
        <Text style={{ fontSize: 20, fontWeight: 'bold', color: 'white', paddingLeft: 20 }}>redBus Wallet</Text>
      </View>
