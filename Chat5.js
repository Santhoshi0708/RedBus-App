...
export default function ChatBot({navigation}) {
  const [messages, setMessages] = useState([
    ...
    {id:2, text:'redBus Wallet', sender:'user'}
  ]);
  ...
  const options = [
    'Need help with using wallet amount for booking',
    ...
    <View style={styles.container}>
      {/* Chat Messages */}
       <View style={{ flexDirection: 'row', alignItems: 'center', height: 60, }}>
                ...
                <View>
                <Text style={{ fontSize: 22, marginLeft: 15 ,color:'black',fontWeight:'bold'}}>redBus Wallet Help</Text>
                <Text style={{fontSize:16,color:'grey',marginLeft:15}}>Need any help with redBus Wallet?</Text>
                </View>
              </View>
     <ScrollView >      
      <FlatList
      ...
      />
       <View style={{ backgroundColor: 'lightgrey', padding: 20, marginRight: 70, marginTop: 40, borderRadius: 10 }}>
                          <Text style={{ fontSize: 16, color: 'black' }}>Sure, What help do you need with</Text>
                          <Text style={{ fontSize: 16, color: 'black' }}>redBus wallet</Text>
      
                          <View style={{ backgroundColor: 'white', padding: 20, marginTop: 10, borderColor: 'lightgrey', borderWidth: 0.5 }}>
