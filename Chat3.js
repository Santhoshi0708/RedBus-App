...
export default function ChatBot({navigation}) {
  const [messages, setMessages] = useState([
    ...
    {id:2, text:'New bus booking help', sender:'user'}
    ...
    <View style={styles.container}>
      {/* Chat Messages */}
       <View style={{ flexDirection: 'row', alignItems: 'center', height: 60, }}>
                ...
                <View>
                <Text style={{ fontSize: 22, marginLeft: 15 ,color:'black',fontWeight:'bold'}}>New bus booking help</Text>
                <Text style={{fontSize:16,color:'grey',marginLeft:15}}>Bus availability/Child fare,Luggage....</Text>
                </View>
              </View>
     <ScrollView >      
      <FlatList
      ...
      />
       <View style={{ backgroundColor: 'lightgrey', padding: 20, marginRight: 70, marginTop: 40, borderRadius: 10 }}>
                          <Text style={{ fontSize: 16, color: 'black' }}>Sure, I will be happy to help You!</Text>
                          <Text style={{ fontSize: 16, color: 'black' }}>What do you need help with?</Text>
