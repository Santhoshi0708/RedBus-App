...
const places = [
  ...
  const Data = [{ id: 1, name: 'Ac/Sleeper', imgurl: 'https://tse2.mm.bing.net/th?id=OIP.fAyKBsqfDrdkFdkfDVZ9cwHaEc&pid=Api&P=0&h=220' },
  ...
  { id: 6, name: 'Lahari Non A/c', imgurl: 'https://tse2.mm.bing.net/th?id=OIP.tq5f2HlkJ8UWV7bIz2tbBAHaEK&pid=Api&P=0&h=220' },
  ];
  const Data2 = [{ id: 1, t1: 'Hyderabad - Vijayawada', t3: 'From', t4: ' ₹ 352', t5: 'Book Now' },
  { id: 2, t1: 'Secunderabad - Vijayawada', t3: 'From', t4: ' ₹ 352', t5: 'Book Now' },
  { id: 3, t1: 'Vijayawada - Secunderabad', t3: 'From', t4: ' ₹ 352', t5: 'Book Now' },
  { id: 4, t1: 'Vijayawada - Hyderabad ', t3: 'From', t4: ' ₹ 352', t5: 'Book Now' },
  { id: 5, t1: 'Visakhapatnam - Annavaram', t3: 'From', t4: ' ₹ 417', t5: 'Book Now' },
  ];
  const content = language === 'english'
    ...
    : {
      heading: 'ఎందుకు redBus లో బుకింగ్ చేయాలి?',
      steps: [
        { id: 1,icon: 'text-box-check-outline', title: 'ప్రయాణ వివరాలు ఇవ్వండి', subtitle: 'ఎక్కడినుంచి ఎక్కడికి, ఎప్పుడు అనేది ఇవ్వండి' },
        { id: 2,icon: 'bus-clock', title: 'బస్ ఎంచుకోండి', subtitle: 'మా లిస్ట్ నుండి మీకు నచ్చిన బస్‌ను ఎంచుకోండి' },
        { id: 3,icon: 'car-child-seat', title: 'సీటు ఎంచుకోండి', subtitle: 'మీ సీటు మరియు బోర్డింగ్ / డ్రాపింగ్ పాయింట్లు ఎంచుకోండి' },
        { id: 4,icon: 'credit-card-marker', title: 'కాంటాక్ట్ డీటెయిల్స్ & చెల్లింపు', subtitle: 'మీ కాంటాక్ట్ వివరాలు ఇవ్వండి మరియు చెల్లింపు చేయండి' },
      ]
    };
  useEffect(() => {
    let isMounted = true;
    ...
    <Provider>
      <ScrollView contentContainerStyle={{ paddingBottom: 100, }}>
        <View style={{ flexDirection: 'row', alignItems: 'center', padding: 10, backgroundColor: 'red', height: 60, }}>
          ...
          <Text style={{ fontSize: 22, marginLeft: 15 ,color:'white',fontWeight:'bold'}}>TSRTC Booking</Text>
        </View>
        <View style={{ padding: 20 }}>
          <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 20 }}>
            ...
            <Image source={{ uri: 'https://tse2.mm.bing.net/th?id=OIP.RIZK8aRa1ofMWJKNL5sTkwHaHa&pid=Api&P=0&h=220'}} style={{ height: 60, width: 60, borderRadius: 50 }} />
          </View>
           <View style={{
            borderWidth: 1,
            borderColor: 'grey',
          ...
          <TouchableOpacity
              onPress={() => console.log('Search touched')}
              style={{
                width: '100%',
...
<ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{paddingHorizontal:20}}>
  <View style={{ flexDirection: 'row', gap: 20, marginTop: 30,}}>
    <Card style={{ height: 180, width: 280, backgroundColor: 'white',shadowColor:'white' }}>
      <Card.Content style={{ marginTop: 10 }}>
        <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
          <Text style={{ fontSize: 20, color: 'black' }}>R Anitha Devi</Text>
        ...
        <Text style={{ marginTop: 10, fontSize: 16, color: 'black' }}>
          Excellent service by TSRTC. Bus was very comfortable and staff was helpful.
        </Text>
      </Card.Content>
    </Card>
    ...
    <Card style={{ height: 180, width: 280, backgroundColor: 'white' ,shadowColor:'white'}}>
      <Card.Content style={{ marginTop: 10 }}>
        <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
          <Text style={{ fontSize: 20, color: 'black' }}>M Srikanth Reddy</Text>
          <View style={{ backgroundColor: 'green', borderRadius: 15, paddingHorizontal: 10 }}>
            <Text style={{ color: 'white', fontWeight: 'bold' }}>★ 5</Text>
          </View>
        </View>
        <Text style={{ marginTop: 10, fontSize: 16, color: 'black' }}>
          Loved the punctuality and cleanliness. TSSRTC is my go-to travel choice in Telangana.
        </Text>
      </Card.Content>
    </Card>
  </View>
          ...
          <View style={{ marginTop: 20 }}>
                     ...
                     <View style={{ flexDirection: 'row', marginTop: 10 }}>
                       ...
                       <TouchableOpacity
                         ...
                         <Text style={{ fontWeight: 'bold' }}>Telugu</Text>
                       </TouchableOpacity>
                     </View>
                   </View>
